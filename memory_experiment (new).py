...
# Requested block repetition counts.
# Capacity lengths 4-9 are repeated 6 times, 10-12 repeated 8 times,
# idiom blocks run 5 times, and all other conditions run 3 times.
FREE_REPS = 3
FREE_N = 16
...
CAPACITY_LENGTHS = [4, 5, 6, 7, 8, 9, 10, 11]
CAPACITY_REPS_BY_LENGTH = {n: 6 for n in range(4, 10)}
CAPACITY_REPS_BY_LENGTH.update({10: 8, 11: 8})
...
class MemoryExperiment:
    ...
    def run_capacity(self):
        ...
        for n in CAPACITY_LENGTHS:
            conditions += [n] * CAPACITY_REPS_BY_LENGTH[n]
